...
Can also be called in terminal:
    python3 src/sol_file_writer.py '{"Instance":"5_4_10.vrp","Time":"1.23","Result":80.6,"Solution":"0 1 2 3 0 0 4 0 0 0 0 0"}'
...
def write_sol_file(solution: dict, num_vehicles=None, output_dir="solutions", optimality_flag=0):
    """
    ...
    record: {"Instance": "5_4_10.vrp",
            "Time": "1.23",
            "Result": 80.6,
            "Solution": "0 1 2 3 0 0 4 0 0 0 0 0"}
    ...
    routes = split_solution_string(solution, num_vehicles)
    ...
    with open(sol_path, "w") as f:
        f.write(f"{objective_value} {optimality_flag}\n")
        for route in routes:
...
def split_solution_string(solution: str, num_vehicles: int) -> list[list[int]]:
    """
    Convert string into routes.
    Example: "0 1 2 3 0 0 4 0 0 0 0 0" -> [[0, 1, 2, 3, 0], [0, 4, 0], [0, 0], [0, 0]]
    """
